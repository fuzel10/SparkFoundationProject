...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <h2  style="color:white;">This website is created by</h2>
            <h1 class = "my-4" style="color:white; text-shadow:2px 2px 2px gray;">Fuzel Malek</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Parul University, Vadodara</b></p>
    </center>
